...
const GlobalResult = () => {
  ...
  return (
    <div className="absolute top-full z-10 mt-3 w-full bg-light-800 py-5 shadow-sm dark:bg-dark-400 rounded-xl">
      <GlobalFilters />
      <div
        className="my-5 h-[1px] bg-light-700/50 
        dark:bg-dark-500/50 mt-3 w-full bg-light-800 
              ...
              result.map((item: any, index: number) => (
                <Link
                  ...
                  className="flex w-full cursor-pointer items-start 
                    gap-3 px-5 py-2.5 hover:bg-light-700/50 dark:hover:bg-dark-200 dark:bg-dark-500/50"
                >
                  <Image
